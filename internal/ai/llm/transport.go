...
func (t *loggingTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	logging.LogLLMHTTPRequest(ctx, meta, string(reqBody))
...
func (t *loggingTransport) httpMeta(req *http.Request, reqBody []byte) logging.LLMHTTPMeta {
	meta := logging.LLMHTTPMeta{
		URL:     req.URL.String(),
...
func (r *responseRecorder) log(statusCode int, body string) {
	r.once.Do(func() {
		logging.LogLLMHTTPResponse(r.ctx, r.meta, statusCode, body, time.Since(r.start))
	})
}
